...
// read a specified number of bytes from a specified address
...
// fast-read a specified number of bytes from a specified address
...
// reset the chip, i.e. its registers, this doesn't erase the memory
void reset_W25Q64JV(){
	// CS low, SPI slave starts to listen
	CS_LOW();
	// send instruction
...
// read and return the content of status register 1
...
// poll and wait for the busy-flag in status register 1
